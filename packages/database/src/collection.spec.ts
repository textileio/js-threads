...
describe('Collection', () => {
  ...
  describe('complex', () => {
    ...
    describe('write transaction', () => {
      ...
      it.skip('should not reflect uncommitted entities', async () => {
        // @todo: Currenrly, transactions are _not_ atomic, or even really transactions in the
        // normal sense. They only provide locking for multi-read/single-write access to a given
        // collection.
      })
