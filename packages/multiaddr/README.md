# Multiaddress _(multiaddr)_

Multi addresses for Textile's Threads protocol & database
...
[![npm (scoped)](https://img.shields.io/npm/v/@textile/multiaddr.svg)](https://www.npmjs.com/package/@textile/multiaddr)
